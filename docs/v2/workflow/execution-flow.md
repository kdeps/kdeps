...
See [Loop](/workflow/loop) for full details.
...
- [Agent mode](/agent/) - LLM-driven tool calling
- [Validation & control flow](/workflow/validation) - skip, check, and error handling
- [Loop](/workflow/loop) - while-loop iteration
