...
- [Python resource](/workflow/resources/python) - data processing scripts
- [HTTP client](/workflow/resources/http-client) - external API calls
- [Workflow configuration](/workflow/configuration) - connection settings
