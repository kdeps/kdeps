...
func TestEnforcePklVersion(t *testing.T) {
	...
	lowLine := "amends \"package://schema.kdeps.com/core@0.4.1-dev#/Kdeps.pkl\""
...
func TestEnforcePklFilename(t *testing.T) {
	...
	lineCfg := "amends \"package://schema.kdeps.com/core@0.4.1-dev#/Kdeps.pkl\""
	require.NoError(t, EnforcePklFilename(ctx, lineCfg, "/path/to/.kdeps.pkl", logger))

	// Good workflow.pkl
	lineWf := "amends \"package://schema.kdeps.com/core@0.4.1-dev#/Workflow.pkl\""
	require.NoError(t, EnforcePklFilename(ctx, lineWf, "/some/workflow.pkl", logger))

	// Resource.pkl must not have those filenames
	lineResource := "amends \"package://schema.kdeps.com/core@0.4.1-dev#/Resource.pkl\""
	...
	unknownLine := "amends \"package://schema.kdeps.com/core@0.4.1-dev#/Unknown.pkl\""
...
func TestEnforcePklTemplateAmendsRules_MultipleAmends(t *testing.T) {
	...
	content := `amends "package://schema.kdeps.com/core@0.4.1-dev#/Resource.pkl"
amends "package://schema.kdeps.com/core@0.4.1-dev#/Utils.pkl"
...
func TestEnforcePklTemplateAmendsRules_InvalidAmends(t *testing.T) {
	...
	content := `amends "package://schema.kdeps.com/core@0.4.1-dev#/Resource.pkl"
amends "package://invalid.com/core@0.4.1-dev#/Invalid.pkl"
