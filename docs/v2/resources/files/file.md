...
- [Exec resource](/resources/scripting/exec) - shell commands (use for CLI tools that lack a native resource)
- [Python resource](/resources/scripting/python) - complex data processing
- [Git resource](/resources/files/git) - version control operations
- [Code intelligence resource](/resources/code-intelligence/navigation) - code navigation and search
