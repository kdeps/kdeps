...
See [Graphing an Indexed Folder](/resources/code-intelligence/graph) for the full reference: which file types get reference extraction, the `extensions` opt-in, and worked examples for all four operations.
