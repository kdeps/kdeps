...
func knownConfigEnvVars() []string {
	vars := []string{
		...
		EnvChatStreaming, EnvChatTemperature,
		EnvChatMaxTokens, EnvChatTopP,
		EnvChatFrequencyPenalty, EnvChatPresencePenalty,
		EnvChatMaxOutputBytes,
		"KDEPS_HTTP_TIMEOUT", EnvHTTPFollowRedirects,
		"KDEPS_HTTP_PROXY",
		EnvHTTPRetryMaxAttempts, "KDEPS_HTTP_RETRY_BACKOFF",
		"KDEPS_HTTP_RETRY_MAX_BACKOFF", "KDEPS_HTTP_RETRY_ON",
		EnvHTTPMaxResponseBytes,
		"KDEPS_PYTHON_TIMEOUT", EnvPythonMaxOutputBytes,
		"KDEPS_EXEC_TIMEOUT", EnvExecMaxOutputBytes,
