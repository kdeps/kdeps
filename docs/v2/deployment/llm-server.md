...
A: "Recipe catalog" {shape: rectangle}
B: "kdeps llm build" {shape: rectangle}
C: Docker {shape: rectangle}
D: ISO {shape: rectangle}
E: Kubernetes {shape: rectangle}
F: "kdeps client" {shape: rectangle}
