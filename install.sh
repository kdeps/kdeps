...
usage() {
  this=$1
  cat <<EOF
$this: download go binaries for kdeps/kdeps

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/kdeps/kdeps/releases
...
get_binaries() {
  case "$PLATFORM" in
    darwin/amd64) BINARIES="kdeps" ;;
    darwin/arm64) BINARIES="kdeps" ;;
    linux/amd64) BINARIES="kdeps" ;;
    linux/arm64) BINARIES="kdeps" ;;
    windows/386) BINARIES="kdeps" ;;
    windows/amd64) BINARIES="kdeps" ;;
    *)
