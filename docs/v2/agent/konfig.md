...
| `presets` | Every named harness/event bundle (`frugal`, `balanced`, `thorough`, ...) - built-in plus any `~/.kdeps/presets/*.yaml` overrides, merged by name. See [presets](./events.md#presets) |
