...
var configEnvVarStatic = map[string]string{
	...
	"resource_defaults.chat.streaming":          EnvChatStreaming,
	"resource_defaults.chat.temperature":        EnvChatTemperature,
	"resource_defaults.chat.max_tokens":         EnvChatMaxTokens,
	"resource_defaults.chat.top_p":              EnvChatTopP,
	"resource_defaults.chat.frequency_penalty":  EnvChatFrequencyPenalty,
	"resource_defaults.chat.presence_penalty":   EnvChatPresencePenalty,
	"resource_defaults.http.timeout":            "KDEPS_HTTP_TIMEOUT",
	"resource_defaults.http.follow_redirects":   EnvHTTPFollowRedirects,
	"resource_defaults.http.proxy":              "KDEPS_HTTP_PROXY",
	"resource_defaults.http.retry_max_attempts": EnvHTTPRetryMaxAttempts,
