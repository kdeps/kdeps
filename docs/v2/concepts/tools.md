...
This page covers workflow mode tools, defined in `chat.tools` on a `chat:` resource. In agent mode, tools are whole workflows and components instead - see [Agent mode](/modes/agent-loop-mode).
