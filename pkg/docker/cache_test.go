...
func TestGetLatestAnacondaVersionsSuccess(t *testing.T) {
	html := `Anaconda3-20.4.1-dev7-1-Linux-x86_64.sh Anaconda3-20.4.1-dev5-1-Linux-aarch64.sh` +
...
func (archHTMLTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	html := `<html><body>
        ...
        <a href="Anaconda3-20.4.1-dev1-0-Linux-aarch64.sh">old-y</a>
        </body></html>`
...
<a href="Anaconda3-2025.01-0-Linux-aarch64.sh">Anaconda3-2025.01-0-Linux-aarch64.sh</a>`
		return &http.Response{StatusCode: 200, Body: io.NopCloser(bytes.NewBufferString(html)), Header: make(http.Header)}, nil
	default:
