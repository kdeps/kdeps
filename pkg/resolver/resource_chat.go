...
// convertToString converts a value to a string, handling different types.
func convertToString(value interface{}, paramName, toolName string, logger *logging.Logger) string {
	switch v := value.(type) {
	case string:
		return v
	case float64:
