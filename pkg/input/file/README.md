...
- [docs/v2/modes/workflow-mode.md](../../../../docs/v2/modes/workflow-mode.md) — step-by-step tutorial
- [docs/v2/resources/overview.md](../../../../docs/v2/resources/overview.md) — full input sources reference
