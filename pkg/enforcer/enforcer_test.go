...
func TestEnforcePklTemplateAmendsRules_MultipleAmends(t *testing.T) {
	...
	content := `amends "package://schema.kdeps.com/core@0.3.0#/Resource.pkl"
amends "package://schema.kdeps.com/core@0.3.0#/Utils.pkl"
...
func TestEnforcePklTemplateAmendsRules_InvalidAmends(t *testing.T) {
	...
	content := `amends "package://schema.kdeps.com/core@0.3.0#/Resource.pkl"
amends "package://invalid.com/core@0.3.0#/Invalid.pkl"
