...
- [SQL resource](/workflow/resources/sql) - database operations
- [LLM resource](/workflow/resources/llm) - AI model integration
- [Unified API](/workflow/data-access) - data access patterns
