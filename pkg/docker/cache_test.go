...
func TestGetLatestAnacondaVersionsSuccess(t *testing.T) {
	html := `Anaconda3-2023.07-1-Linux-x86_64.sh Anaconda3-2023.05-1-Linux-aarch64.sh` +
		` Anaconda3-20.4.20-1-Linux-x86_64.sh Anaconda3-20.4.28-1-Linux-aarch64.sh`
	...
	if versions["x86_64"] != "20.4.20-1" || versions["aarch64"] != "20.4.28-1" {
...
func (archHTMLTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	html := `<html><body>
        <a href="Anaconda3-20.4.20-1-Linux-x86_64.sh">x</a>
        <a href="Anaconda3-20.4.29-1-Linux-aarch64.sh">y</a>
        <a href="Anaconda3-20.4.22-0-Linux-x86_64.sh">old-x</a>
...
func TestGetLatestAnacondaVersionsMultiArch(t *testing.T) {
	...
	if versions["x86_64"] != "20.4.20-1" {
		t.Fatalf("unexpected version for x86_64: %s", versions["x86_64"])
	}
	if versions["aarch64"] != "20.4.29-1" {
...
func (m mockHTMLTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	if req.URL.Host == "repo.anaconda.com" {
		html := `<html><body>
<a href="Anaconda3-20.4.20-1-Linux-x86_64.sh">Anaconda3-20.4.20-1-Linux-x86_64.sh</a>
<a href="Anaconda3-20.4.29-1-Linux-aarch64.sh">Anaconda3-20.4.29-1-Linux-aarch64.sh</a>
</body></html>`
		resp := &http.Response{
			StatusCode: 200,
...
func TestGenerateURLs_UseLatestWithStubsLow(t *testing.T) {
	...
	http.DefaultTransport = stubRoundTrip(func(req *http.Request) (*http.Response, error) {
		...
		if strings.Contains(req.URL.Host, "repo.anaconda.com") {
			body = `Anaconda3-20.4.20-1-Linux-x86_64.sh Anaconda3-20.4.20-1-Linux-aarch64.sh`
		} else {
...
func (m mockTransport) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	if strings.Contains(req.URL.Path, "/releases/latest") { // GitHub API
		...
		body = `Anaconda3-20.4.25-0-Linux-x86_64.sh
Anaconda3-20.4.25-0-Linux-aarch64.sh`
	}
	resp := &http.Response{
		StatusCode: http.StatusOK,
...
func TestGetLatestAnacondaVersions(t *testing.T) {
	...
	html := `
        <a href="Anaconda3-20.4.20-1-Linux-x86_64.sh">x86</a>
        <a href="Anaconda3-20.4.22-0-Linux-x86_64.sh">old</a>
        <a href="Anaconda3-20.4.20-1-Linux-aarch64.sh">arm</a>
    `
	...
	assert.NoError(t, err)
	assert.Equal(t, "20.4.20-1", versions["x86_64"])
	assert.Equal(t, "20.4.20-1", versions["aarch64"])
}
...
func (m mockRoundTripper) RoundTrip(req *http.Request) (*http.Response, error) {
	...
	body := `
<html><body>
<a href="Anaconda3-20.4.25-0-Linux-x86_64.sh">Anaconda3-20.4.25-0-Linux-x86_64.sh</a><br>
<a href="Anaconda3-20.4.20-1-Linux-aarch64.sh">Anaconda3-20.4.20-1-Linux-aarch64.sh</a><br>
</body></html>`
...
func TestGetLatestAnacondaVersionsMocked(t *testing.T) {
	...
	if versions["x86_64"] != "20.4.25-0" {
		t.Fatalf("expected x86_64 version '20.4.25-0', got %s", versions["x86_64"])
	}
	if versions["aarch64"] != "20.4.20-1" {
		t.Fatalf("expected aarch64 version '20.4.20-1', got %s", versions["aarch64"])
	}
}
...
func TestGetLatestAnacondaVersionsMock(t *testing.T) {
    ...
    <a href="Anaconda3-20.4.20-1-Linux-x86_64.sh">x</a>
    <a href="Anaconda3-20.4.25-1-Linux-aarch64.sh">y</a>
    </body></html>`
