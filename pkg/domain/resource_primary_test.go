...
func TestPrimaryResourceTypesList(t *testing.T) {
	...
	if got != "chat, httpClient, sql, python, exec, agent, component, scraper, "+
		"embedding, searchLocal, searchWeb, telephony, browser, botReply, email, file, git, codeIntelligence, "+
		"apiResponse" {
...
func TestPrimaryResourceTypeNames_MatchesExecutorRegistry(t *testing.T) {
	...
	want := []string{
		...
		"telephony", "browser", "botReply", "email", "file", "git", "codeIntelligence", "apiResponse",
	}
