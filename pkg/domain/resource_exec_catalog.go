...
var resourceExecCatalog = []ResourceExecCatalogEntry{
	...
	catalogEntry("file",
		func(r *Resource) bool { return r.File != nil },
		func(a *ActionConfig) bool { return a.File != nil }),
	catalogEntry("git",
		func(r *Resource) bool { return r.Git != nil },
		func(a *ActionConfig) bool { return a.Git != nil }),
	catalogEntry("codeIntelligence",
		func(r *Resource) bool { return r.CodeIntelligence != nil },
		func(a *ActionConfig) bool { return a.CodeIntelligence != nil }),
	catalogEntry("loader",
		func(r *Resource) bool { return r.Loader != nil },
		func(a *ActionConfig) bool { return a.Loader != nil }),
	catalogEntry("vectorStore",
		func(r *Resource) bool { return r.VectorStore != nil },
		func(a *ActionConfig) bool { return a.VectorStore != nil }),
	catalogEntry("transcribe",
		func(r *Resource) bool { return r.Transcribe != nil },
		func(a *ActionConfig) bool { return a.Transcribe != nil }),
	catalogEntry("ocr",
		func(r *Resource) bool { return r.OCR != nil },
		func(a *ActionConfig) bool { return a.OCR != nil }),
