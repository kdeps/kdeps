...
- [Skill for coding agents](/agent/ai-assisted-authoring) - YAML scaffolding for Claude Code, Cursor, Grok
- [Agent mode](/agent/) - starting the loop
- [REPL slash commands](/agent/commands) - invoking skills and templates
