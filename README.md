...
## Why not just use a chat CLI or MCP?

Chat AIs (Claude, Gemini, ChatGPT) and their CLI/MCP extensions are tools you operate. You prompt them, they respond, the session ends. They are powerful, but they are not something you ship.
...
MCP is a good protocol for giving a chat AI access to your tools. kdeps is for when your product needs AI capabilities baked in - not bolted on through a chat interface.
