...
// setRecord stores a memory record in the database
...
// deleteRecord removes a memory record from the database
...
// clearRecords removes all memory records from the database
...
// getRecord retrieves a memory record from the database
