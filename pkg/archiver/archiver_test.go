...
Run {
	...
	t.Run("ValidateSchemaProperties", func(t *testing.T) {
		...
		// Verify v0.4.6 workflow properties are defined
		...
		// Verify v0.4.6 resource properties are defined
