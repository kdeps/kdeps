...
**Resource executors**: LLM (Ollama/OpenAI-compatible), HTTP client, SQL (5 drivers), Python (uv), shell exec, scraper (15 content types), TTS, bot reply, and API response.
