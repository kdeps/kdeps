Feature: API
  ...
  Scenario: GET request points to action
    When I GET request to "/resource1?params1=1&params2=2" with data "hello" and header name "hello,world" that maps to "foo,bar"
    Then I should see a "request.pkl" in the "/agent/api/" folder
