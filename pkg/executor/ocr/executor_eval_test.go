...
func TestResolveConfig_InterpolatesFields(t *testing.T) {
	ctx := newTestCtx(t)
	require.NoError(t, ctx.Set("f", "/tmp/scan.png"))
	require.NoError(t, ctx.Set("l", "eng"))
