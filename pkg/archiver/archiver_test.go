...
Run {
	...
	t.Run("ValidateSchemaProperties", func(t *testing.T) {
		...
		// Verify v0.4.4 workflow properties are defined
		...
		// Verify v0.4.4 resource properties are defined
