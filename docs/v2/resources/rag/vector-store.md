...
`loader:`'s output documents map directly onto `vectorStore:`'s `documents:` field - see the [Loader Resource](/resources/rag/loader#rag-pipeline-example) for the full load-then-index pipeline.

## See also

- [Loader resource](/resources/rag/loader) - load files/URLs into documents before indexing
- [Embedding resource](/resources/rag/embedding) - local SQLite-backed alternative, no external service required
