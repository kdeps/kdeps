...
source "$SCRIPT_DIR/test_examples_llamafile_chat.sh"
source "$SCRIPT_DIR/test_examples_page_summarizer.sh"
source "$SCRIPT_DIR/test_examples_config_namespace.sh"
