...
- [HTTP client](/resources/web/http-client) - simple HTTP requests without a browser
- [Scraper](/resources/web/scraper) - text extraction from already-fetched pages
- [Python](/resources/scripting/python) - Custom Python automation scripts
