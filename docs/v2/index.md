...
features:
  ...
  - icon: 🔁
    ...
    details: Ordered, Repeatable Systems ensure every agent run is deterministic and auditable. Same inputs always produce same outputs — full reproducibility by design.
  - icon: 📝
