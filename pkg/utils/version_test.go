...
func TestValidateSchemaVersion(t *testing.T) {
	tests := []struct {
		...
		{"valid version above minimum", "0.4.1-dev", "0.4.1-dev", false},
		{"valid version equal to minimum", "0.4.1-dev", "0.4.1-dev", false},
		{"valid higher version", "1.0.0", "0.4.1-dev", false},
		{"below minimum", "0.1.9", "0.4.1-dev", true},
		{"empty version", "", "0.4.1-dev", true},
		{"invalid format", "1.2", "0.4.1-dev", true},
		{"non-numeric", "1.a.3", "0.4.1-dev", true},
		{"negative version", "-1.0.0", "0.4.1-dev", true},
	}
...
func TestIsSchemaVersionSupported(t *testing.T) {
	tests := []struct {
		...
		{"version above minimum", "0.4.1-dev", "0.4.1-dev", true},
		{"minimum version", "0.4.1-dev", "0.4.1-dev", true},
		{"higher version", "1.0.0", "0.4.1-dev", true},
		{"below minimum", "0.1.9", "0.4.1-dev", false},
		{"empty version", "", "0.4.1-dev", false},
		{"invalid format", "1.2", "0.4.1-dev", false},
	}
